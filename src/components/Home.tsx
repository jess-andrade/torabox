...
export default function Home() {
  return (
    <>
      ...
      <section id="home">
        {/* main container */}
        <div className="flex bg-[url('../../public/wpp2.png')] min-w-full min-h-screen">

          {/* content */}
          <div className='flex flex-wrap min-w-full flex-row items-center justify-start pl-20 pt-24'>
              ...
              <div className='flex flex-wrap flex-col'>
                ...
                >
                  <div className='flex flex-col '>
                    <div className='flex flex-row text-[#f1f5f9] font-bold text-6xl tracking-[.24em]'> TORABOX <p className='text-[#fca04f]'> . </p></div>
                    <div className='text-[#f1f5f9] text-2xl pt-4'> Soluções inteligêntes e tecnológicas para você e seu negócio.</div>
                  </div>
                </motion.div>
                ...
                <div className='flex justify-end pt-20'>     <DownButton /> </div>
              </div>
