            ...
            >
              <div className="flex flex-col">
                <div className="flex flex-col justify-center ">
                  {/* title */}
                  <h1 className="text-4xl font-bold text-[#f1f5f9] tracking-[.24em] pb-4 justify-center pt-14">
                    {t("title")}
                  </h1>
                  {/* divider */}
                ...
                {/* subtitle */}
                <h2 className="flex flex-wrap max-w-42 text-xl font-bold text-[#a6a29e] tracking-[.20em] justify-center pt-6">
                  {t("subtitle")}
                </h2>
              </div>
            </motion.div>
