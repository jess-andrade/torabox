          ...
          <div className="flex flex-wrap flex-row items-start place-content-evenly text-justify gap-x-4 gap-y-10 pb-3.5">
            ...
            >
              <div className="flex flex-col items-center max-w-80 gap-6">
                ...
                <p className="text-sm">
                  Nossa missão é capacitar indivíduos e empresas por meio da
                  tecnologia, fornecendo soluções inovadoras e personalizadas
                  que impulsionem o crescimento, promovam a eficiência e
                  facilitem a realização de objetivos.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col items-center max-w-80 gap-4">
                ...
                <p className="text-sm">
                  Colaboração, Comprometimento, Inovação e Aprendizado contínuo{" "}
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col items-center max-w-80 gap-4">
                ...
                <p className="text-sm">
                  {" "}
                  Almejamos um futuro onde nossa equipe seja reconhecida por sua
                  capacidade de transformar desafios em oportunidades e criar
